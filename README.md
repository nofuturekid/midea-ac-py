...
[![Code Quality Checks](https://github.com/nofuturekid/midea-ac-py/actions/workflows/checks.yml/badge.svg)](https://github.com/nofuturekid/midea-ac-py/actions/workflows/checks.yml)
[![Validate with hassfest](https://github.com/nofuturekid/midea-ac-py/actions/workflows/hassfest.yml/badge.svg)](https://github.com/nofuturekid/midea-ac-py/actions/workflows/hassfest.yml)
[![HACS Action](https://github.com/nofuturekid/midea-ac-py/actions/workflows/hacs.yml/badge.svg)](https://github.com/nofuturekid/midea-ac-py/actions/workflows/hacs.yml)
...
- Dev parameter diagnostics (opt-in, disabled by default): expansion valve position, outdoor target frequency, IPM temperature (raw), DC bus voltage (raw), return air temperature (raw), decoded outdoor/indoor status flags (faults, frequency limits, load states — active flag names as attributes), compressor run time (current/total), device run time counters, min/max voltage, fault count, min/max outdoor temperature, peak currents (raw), compensated target temperature, defrost step, indoor target fan speed

**Additional controls:**

- Temp Range switch + min/max number entities (temperature range limit; formerly mislabeled "Child Lock")
